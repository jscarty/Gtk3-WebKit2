# This Makefile is for the Gtk3::WebKit2 extension to perl.
#
...
#     ABSTRACT => q[WebKit2 bindings for Perl]
#     AUTHOR => [q[Emmanuel Rodriguez <potyl@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[6.30] }
#     DISTNAME => q[Gtk3-WebKit2]
#     EXE_FILES => []
#     LICENSE => q[lgpl]
#     NAME => q[Gtk3::WebKit2]
#     PREREQ_PM => { Glib::Object::Introspection=>q[0], Gtk3=>q[0], Test::NeedsDisplay=>q[0] }
#     TEST_REQUIRES => { Test::NeedsDisplay=>q[0] }
#     VERSION => q[0.06]
#     test => { TESTS=>q[t/*.t] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Gtk3/WebKit2.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIBDEP)$(DFSEP)Config.pm $(PERL_INCDEP)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Gtk3
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Gtk3
...
TO_INST_PM = lib/Gtk3/JavsScriptCore.pm \
	lib/Gtk3/WebKit2.pm
...
manifypods : pure_all config  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) -u \
	  lib/Gtk3/WebKit2.pm $(INST_MAN3DIR)/Gtk3::WebKit2.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''WebKit2 bindings for Perl'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Emmanuel Rodriguez <potyl@cpan.org>'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'build_requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::NeedsDisplay: '\''0'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: Gtk3-WebKit2' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Glib::Object::Introspection: '\''0'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "WebKit2 bindings for Perl",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Emmanuel Rodriguez <potyl@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Gtk3-WebKit2",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Glib::Object::Introspection" : "0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Gtk3" : "0"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      },' >> META_new.json
	$(NOECHO) $(ECHO) '      "test" : {' >> META_new.json
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Test::NeedsDisplay" : "0"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="Gtk3-WebKit2" VERSION="0.06">' > Gtk3-WebKit2.ppd
	$(NOECHO) $(ECHO) '    <ABSTRACT>WebKit2 bindings for Perl</ABSTRACT>' >> Gtk3-WebKit2.ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Emmanuel Rodriguez &lt;potyl@cpan.org&gt;</AUTHOR>' >> Gtk3-WebKit2.ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> Gtk3-WebKit2.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Glib::Object::Introspection" />' >> Gtk3-WebKit2.ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Gtk3::" />' >> Gtk3-WebKit2.ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="x86_64-linux-thread-multi-5.26" />' >> Gtk3-WebKit2.ppd
	$(NOECHO) $(ECHO) '        <CODEBASE HREF="" />' >> Gtk3-WebKit2.ppd
	$(NOECHO) $(ECHO) '    </IMPLEMENTATION>' >> Gtk3-WebKit2.ppd
	$(NOECHO) $(ECHO) '</SOFTPKG>' >> Gtk3-WebKit2.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  'lib/Gtk3/JavsScriptCore.pm' 'blib/lib/Gtk3/JavsScriptCore.pm' \
	  'lib/Gtk3/WebKit2.pm' 'blib/lib/Gtk3/WebKit2.pm' 
